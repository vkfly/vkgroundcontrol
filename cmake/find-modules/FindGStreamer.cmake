...
if(NOT DEFINED GStreamer_ROOT_DIR)
    message(STATUS "NOT DEFINED GStreamer_ROOT_DIR")
...
elseif(ANDROID)
    ...
    CPMAddPackage(
        ...
        URL "file://${CMAKE_SOURCE_DIR}/external/gstreamer-1.0-android-universal-${GStreamer_FIND_VERSION}.tar.xz"
    ...
    if(GStreamer_USE_STATIC_LIBS)
        ...
        foreach(plugin IN LISTS GSTREAMER_PLUGINS)
            ...
            if(GST_PLUGIN_${plugin}_FOUND)
                ...
                message(STATUS "not plugin found:${plugin}")
