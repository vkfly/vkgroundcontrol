...
public:
    ...
    QVariant rawValue() const {
        return _rawValue;    /// value prior to translation, careful
    }
    ...
    bool typeIsString() const {
        return (type() == FactMetaData::valueTypeString);
    }
    bool typeIsBool() const {
        return (type() == FactMetaData::valueTypeBool);
    }
    ...
    bool sendValueChangedSignals () const {
        return _sendValueChangedSignals;
    }
    bool deferredValueChangeSignal() const {
        return _deferredValueChangeSignal;
    }
