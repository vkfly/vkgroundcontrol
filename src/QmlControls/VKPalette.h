...
/*!
 VKPalette is used in QML ui to expose color properties for the QGC palette. There are two
...
class VKPalette : public QObject {
    Q_OBJECT
    // QML_ELEMENT
...
public:
    ...
    DEFINE_QGC_COLOR(titleColor,                    setTitleColor)
    ...
    VKPalette(QObject* parent = nullptr);
    ~VKPalette();
...
private:
    ...
    static QList<VKPalette*> _paletteObjects;    ///< List of all active VKPalette objects
};
