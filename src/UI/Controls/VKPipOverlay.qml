...
Item {
    ...
    property real   _pipSize:           200 * sw / (9/16)
    ...
    function _initForItems() {
        var item1IsFull = VKGroundControl.loadBoolGlobalSetting(item1IsFullSettingsKey, true)
        if (item1 && item2) {
            ...
            videoVisible= item1IsFull ? false : true
        ...
        _setPipIsExpanded(VKGroundControl.loadBoolGlobalSetting(_pipExpandedSettingsKey, true))
    }
    ...
    function _swapPip() {
        ...
        VKGroundControl.saveBoolGlobalSetting(item1IsFullSettingsKey, item1IsFull)
    }

    function _setPipIsExpanded(isExpanded) {
        VKGroundControl.saveBoolGlobalSetting(_pipExpandedSettingsKey, isExpanded)
    ...
    // Resize icon
    Image {
        source:         "/qmlimages/icon/pipResize.svg"
    ...
    Image {
        id:             hidePIP
        source:         "/qmlimages/icon/pipHide.svg"
        mipmap:         true
        fillMode:       Image.PreserveAspectFit
        anchors.left:   parent.left
