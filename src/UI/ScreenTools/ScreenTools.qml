...
import VKGroundControl.ScreenToolsController
...
Item {
    ...
    property color  titleColor:"#3bae36"
    ...
    property real realPixelDensity: {
        ...
        // if(VKGroundControl.corePlugin.options.devicePixelDensity != 0) {
        //     return VKGroundControl.corePlugin.options.devicePixelDensity
        // }
    ...
    property real scaleWidth: isMobile ? Screen.width / defaultWidth * 1.4 : Screen.width / defaultWidth
    property real scaleHeight: isMobile ? Screen.width / defaultWidth * 0.7 : Screen.width / defaultWidth * 0.5
    ...
    */
    Connections {
        target: VKGroundControl.settingsManager.appSettings.appFontPointSize
        function onValueChanged() {
            _setBasePointSize(VKGroundControl.settingsManager.appSettings.appFontPointSize.value)
        }
    }
    ...
    function _setBasePointSize(pointSize) {
        ...
        // toolbarHeight           = toolbarHeight * VKGroundControl.corePlugin.options.toolbarHeightMultiplier
    }
    ...
    Text {
        ...
        Component.onCompleted: {
            ...
            var _appFontPointSizeFact = VKGroundControl.settingsManager.appSettings.appFontPointSize
